...
export default function SowPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-8 space-y-12 pb-20">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 p-6 bg-zinc-50 dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-inner items-end">
