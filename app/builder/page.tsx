...
export default function BuilderPage() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Content layer */}
      <div className="relative z-10 max-w-6xl mx-auto p-12 space-y-12 border-x border-zinc-100 dark:border-zinc-900 pb-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-12">
          <div className="space-y-12 min-h-[400px] bg-zinc-50/50 dark:bg-zinc-900/20 p-8 rounded-[3rem] border-2 border-dashed border-zinc-200 dark:border-zinc-800 backdrop-blur-sm">
            {sections.length === 0 ? (
